...
contract Token is StandardToken, Ownable {
  ...
  // amount of raised money in wei
    ...
    string public name = "Shad";
    string public symbol = "SD";
    uint public decimals = 2;
    uint public INITIAL_SUPPLY = 10000067;
  ...
  // can be issued only with owners concent
  function issueToken(address beneficiary, uint256 tokens) internal onlyOwner {
